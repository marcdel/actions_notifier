defmodule ActionsNotifierWeb.UserLiveTest do
  use ActionsNotifierWeb.ConnCase

  import Phoenix.LiveViewTest
  import ActionsNotifier.AccountsFixtures

  @create_attrs %{github_token: "some github_token"}
  @update_attrs %{github_token: "some updated github_token"}
  @invalid_attrs %{github_token: nil}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated github_token"
    end
